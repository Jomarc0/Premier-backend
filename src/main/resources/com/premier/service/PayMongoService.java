...
public class PayMongoService {
    ...
    public ApiResponse<TopUpResponse> initiateTopUp(
        ...
        attributes.put("remarks",
                "Passenger ID: " + passenger.getUserId());
        ...
        try {
            ...
            log.info("PayMongo link created: {} for passenger: {}",
                    linkId, passenger.getUserId());
    ...
    public ApiResponse<Map<String, Object>> processPayment(
        ...
        if (passenger.getFcmToken() != null) {
            firebaseService.sendNotification(
                    ...
                    "Top-up Successful! 🎉",
                    "₱" + amount +
                    " added to your Premier Transit card."
            );
        }

        log.info("Top-up SUCCESS: ₱{} for passenger {}",
                amount, passenger.getUserId());
